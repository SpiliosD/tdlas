...
def load_config_txt(path: str) -> Dict[str, str]:
    """
    - Reads config_batch_flashing.txt and returns a dictionary of {key: value_string}.
...
# - MAIN
# =========================================================
def main(config_path: str = "config_batch_flashing.txt") -> None:
...
if __name__ == "__main__":
    # - Run using config_batch_flashing.txt settings
    main("config_batch_flashing.txt")